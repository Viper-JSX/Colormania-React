import { ActionType, ChangeColorModePayload, ChangeTablesSortTermPayload } from "../typescript/types";
...
//}
//
//export function changeTablesSortTerm(payload: ChangeTablesSortTermPayload):ActionType{
