...
function ColorValueInfo({ currentColorModel, currentColorValue } : /*ColorValueInfoProps*/ {currentColorModel: "rgb" | "hsl", currentColorValue: ConvertedColorValue}):JSX.Element{
